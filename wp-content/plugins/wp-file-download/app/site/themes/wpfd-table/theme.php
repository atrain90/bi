...
class WpfdThemeTable extends WpfdTheme
{
    ...
    public static function showTitleHandlebars($config, $params)
    {
        ...
        $template = array(
            'html' => '<a class="wpfd_downloadlink" href="%link$s" title="%title$s"><span class="extcol">%icon$s</span>%croptitle$s</a>',
            'args' => array(
                'link'      => '{{linkdownload}}',
                'title'     => '{{post_title}}',
                'icon'      => $html,
        ...
        echo self::render('<td>' . $args['html'] . '</td>', $args['args']);
    }
    ...
    public static function showTitle($file, $config, $params)
    {
        ...
        $template = array(
            'html' => '<a class="wpfd_downloadlink" href="%link$s" title="%title$s">%icon$s</a>',
            'args' => array(
    ...
    {
        $name = self::$themeName;
        $html = '<th class="essential persist">' . esc_html__('Title', 'wpfd') . '</th>';
    ...
    {
        $name = self::$themeName;
        $html = '<th class="optional">' . esc_html__('Description', 'wpfd') . '</th>';
    ...
    {
        $name = self::$themeName;
        $html = '<th class="optional">' . esc_html__('Version', 'wpfd') . '</th>';
    ...
    {
        $name = self::$themeName;
        $html = '<th class="optional">' . esc_html__('Size', 'wpfd') . '</th>';
    ...
    {
        $name = self::$themeName;
        $html = '<th class="optional">' . esc_html__('Hits', 'wpfd') . '</th>';
    ...
    {
        $name = self::$themeName;
        $html = '<th class="optional">' . esc_html__('Date added', 'wpfd') . '</th>';
    ...
    {
        $name = self::$themeName;
        $html = '<th class="optional">' . esc_html__('Date modified', 'wpfd') . '</th>';
    ...
    {
        $name = self::$themeName;
        $html = '<th class="essential">' . esc_html__('Download', 'wpfd') . '</th>';
