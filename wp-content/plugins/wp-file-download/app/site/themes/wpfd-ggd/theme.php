...
class WpfdThemeGgd extends WpfdTheme
{
    ...
    public static function fileBlockWrapperHandlebars($config, $params)
    {
        ...
        $args = apply_filters(
            ...
            array(
                'html' => '<a class="wpfd-file-link" href="%link$s" data-category_id="%catid$s" data-id="%fileid$s">',
                'args' => array(
                    'link' => $downloadlink,
                    'catid' => '{{catid}}',
                    'fileid' => '{{ID}}'
    ...
    public static function fileBlockWrapper($file, $config, $params)
    {
        ...
        $args = apply_filters(
            ...
            array(
                'html' => '<a class="wpfd-file-link" href="%link$s" data-category_id="%catid$d" data-id="%fileid$d">',
                'args' => array(
                    'link' => $downloadlink,
