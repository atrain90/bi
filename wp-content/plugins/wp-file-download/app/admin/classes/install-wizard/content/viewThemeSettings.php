    ...
    <div class="ju-settings-options">
        ...
        <div class="ju-settings-option-group">
            ...
            <div class="ju-settings-option-item">
                ...
                <input name="<?php wpfd_ce($theme, 'croptitle'); ?>" type="text" value="10" class="inputbox input-block-level ju-input" />
            </div>
            <div class="ju-settings-option-item">
        ...
        <div class="ju-settings-option-group">
            ...
            <?php elseif ($theme === 'tree') : ?>
                <!-- only tree theme -->
                <div class="ju-settings-option-item grid">
                    <label class="ju-setting-label" for="<?php wpfd_ce($theme, 'showtreeborder'); ?>">Show tree border</label>
                    <div class="ju-switch-button">
                        <label class="switch">
                            <input type="checkbox" name="ref_<?php wpfd_ce($theme, 'showtreeborder'); ?>" value="1" checked="" class="inline ju-input">
                            <span class="slider"></span>
                        </label>
                        <input type="hidden" id="<?php wpfd_ce($theme, 'showtreeborder'); ?>" name="<?php wpfd_ce($theme, 'showtreeborder'); ?>" value="1">
                    </div>
                </div>
                <!-- only tree theme -->
                <div class="ju-settings-option-item grid">
                    <label class="ju-setting-label" for="<?php wpfd_ce($theme, 'showbgtitle'); ?>">Show background title</label>
                    <div class="ju-switch-button">
                        <label class="switch">
                            <input type="checkbox" name="ref_<?php wpfd_ce($theme, 'showbgtitle'); ?>" value="1" checked="" class="inline ju-input">
                            <span class="slider"></span>
                        </label>
                        <input type="hidden" id="<?php wpfd_ce($theme, 'showbgtitle'); ?>" name="<?php wpfd_ce($theme, 'showbgtitle'); ?>" value="1">
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ($theme === 'table') : ?>
                <!-- only table theme -->
                <div class="ju-settings-option-item grid">
                    <label class="ju-setting-label" for="<?php wpfd_ce($theme, 'table_styling'); ?>">Stylize table</label>
                    <div class="ju-switch-button">
                        <label class="switch">
                            <input type="checkbox" name="ref_<?php wpfd_ce($theme, 'table_styling'); ?>" value="1" checked="" class="inline ju-input">
                            <span class="slider"></span>
                        </label>
                        <input type="hidden" id="<?php wpfd_ce($theme, 'table_styling'); ?>" name="<?php wpfd_ce($theme, 'table_styling'); ?>" value="1">
                    </div>
                </div>
                <!-- only table theme -->
                <div class="ju-settings-option-item grid">
                    <label class="ju-setting-label" for="<?php wpfd_ce($theme, 'stylingmenu'); ?>">Stylize menu</label>
                    <div class="ju-switch-button">
                        <label class="switch">
