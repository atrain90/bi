...
class WpfdModelConfig extends Model
{
    ...
    public function getThemeParams($theme)
    {
        ...
        $custom_config .= '"' . $theme . '_showbgtitle":"1","' . $theme . '_show' . $theme . 'border":"1","' . $theme . '_showsize":"1","' . $theme . '_croptitle":"0",';
                ...
                if (is_dir($file_path)) {
                    ...
                    if ($data['theme'] === 'table') {
                        if (strtolower($ext) === 'css') {
                            ...
                            $file_contents = str_replace('.table-download-category', '.' . $data['theme_name'] . '-download-category', $file_contents);
