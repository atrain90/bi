    ...
    <div class="content">
        ...
        <div class="list_user">
            <ul class="subsubsub">
                ...
                foreach ($role_links as $role => $role_link) {
                    // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped -- escape inside wpfd_filter_role_links()
                    echo '<li class="' . esc_attr($role) . '">' . $role_link . '</li>';
                }
                ?>
            </ul>
