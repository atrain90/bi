...
<div class="container">
	<h2 class="home_title"><?php _e( 'Basic Settings', 'button-pro' ); ?></h2>
	<div class="input_group icon_simple_none hexagons_none circle_icon_none">
		<div class="input_label">
			<label><?php _e( 'Text', 'button-pro' ); ?></label>
		</div>
		<div class="input_field">
			<input type="text" class="input_box" id="" name="button_text" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['button_text']); ?>">
		</div>
	...
	<div class="input_group">
		<div class="input_label">
			<label><?php _e( 'URL', 'button-pro' ); ?></label>
		</div>
		<div class="input_field">
			<input type="url" class="input_box" name="button_link" placeholder="http://" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['button_link']); ?>">
		</div>
		<div class="clear_fix"></div> 
	</div>
	...
	<div class="input_group">
		<div class="input_label">
			<label><?php _e( 'Target', 'button-pro' ); ?></label>
		</div>
		<div class="input_field">
			<input type="checkbox"  name="button_target" value="1" <?php if($custom_data['button_target']==1){echo "checked";} ?>>
			<label><?php _e( 'Open in new Window', 'button-pro' ); ?></label>
		</div>
		<div class="clear_fix"></div> 
	</div>
	<div class="input_group padding_section icon_with_text_none hexagons_none circle_icon_none">
		<div class="input_label">
			<label><?php _e( 'Padding', 'button-pro' ); ?></label>
		</div>
		<div class="input_field">
			<div class="input input_inline button_padding_top">
				<label><?php _e( 'Top', 'button-pro' ); ?></label>
				<input type="number" class="input_box" name="padding_top" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['padding_top']); ?>">
				<span class="px"><?php _e( 'PX', 'button-pro' ); ?></span>
			</div>

			<div class="input input_inline button_padding_right" >
				<label><?php _e( 'Right', 'button-pro' ); ?></label>
				<input type="number" class="input_box" name="padding_right" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['padding_right']); ?>">
				<span class="px"><?php _e( 'PX', 'button-pro' ); ?></span>
			</div>

			<div class="input input_inline button_padding_bottom">
				<label><?php _e( 'Bottom', 'button-pro' ); ?></label>
				<input type="number" class="input_box" name="padding_bottom" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['padding_bottom']); ?>">
				<span class="px"><?php _e( 'PX', 'button-pro' ); ?></span>
			</div>

			<div class="input text_right input_inline button_padding_left">
				<label><?php _e( 'Left', 'button-pro' ); ?></label>
				<input type="number" class="input_box" name="padding_left" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['padding_left']); ?>">
				<span class="px"><?php _e( 'PX', 'button-pro' ); ?></span>
			</div>
	...
	<div class="input_group button_section hexagons_none circle_icon_none">
		<div class="input_label">
			<label><?php _e( 'Button', 'button-pro' ); ?></label>
		</div>
		<div class="input_field">
			<div class="input two_col button_width">
				<label><?php _e( 'Width', 'button-pro' ); ?></label>
				<input type="number" class="input_box" name="button_width" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['button_width']); ?>">
				<span class="px"><?php _e( 'PX', 'button-pro' ); ?></span>
			</div>

			<div class="input text_right two_col button_height icon_simple_none icon_with_text_none" >
				<label><?php _e( 'Height', 'button-pro' ); ?></label>
				<input type="number" class="input_box" name="button_height" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['button_height']); ?>">
				<span class="px"><?php _e( 'PX', 'button-pro' ); ?></span>
			</div>				
	...
	<div class="input_group text_color_section">
		<div class="input_label">
			<label><?php _e( 'Text Color', 'button-pro' ); ?></label>
		</div>
		<div class="input_field">
			<div class="input two_col">
				<label><?php _e( 'Color', 'button-pro' ); ?></label>
				<input name="button_text_color" type="text" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['button_text_color']); ?>" class="button_color_field" data-default-color="#000000" />
			</div>

			<div class="input two_col" >
				<label><?php _e( 'Hover Color', 'button-pro' ); ?></label>
				<input name="button_text_hover_color" type="text" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['button_text_hover_color']); ?>" class="button_color_field" data-default-color="#000000" />
			</div>				
	...
	<div class="input_group font_section border_none hexagons_none circle_icon_none">
		<div class="input_label">
			<label><?php _e( 'Font', 'button-pro' ); ?></label>
		</div>
		<div class="input_field">
			<div class="input three_col font_family">
				<select name="font_family" class="icon_simple_none">
					
					<?php 					
					$font_pro=array(	"ABeeZee" => "ABeeZee",
							"Abel" => "Abel",
				...
				<input type="number" class="2 icon_with_text_none" name="font_size" value="<?php printf( __( '%s', 'button-pro' ),$custom_data['font_size']); ?>">
				<span class="px icon_with_text_none"><?php _e( 'PX', 'button-pro' ); ?></span>
			</div>
