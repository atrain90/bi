...
require(Button_PATH.'user_view/button_layouts/border_transitions/css/border_transitions_hover.php');
...
<div class="button_wrapper_id_<?php echo $id; ?>">
	<div class="button_container button_container_id_<?php echo $id; ?>">	
		<a href="<?php echo esc_url($custom_data['button_link']); ?>" target="<?php echo $button_target; ?>" id="wd_button" class="<?php echo $custom_data['border_transitions'].'_'.$id;?> wd_button_<?php echo $id;?>" <?php echo esc_attr($attribute); ?>><?php printf( __( '%s', 'button-pro' ),$custom_data['button_text']); ?></a>	
